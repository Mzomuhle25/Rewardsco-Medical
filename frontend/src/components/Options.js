...
import {sortBySooner,sortByLater,sortByDefault,
  checkBoxConfirmed,checkBoxPaymentPending,setText,}          from "../Action/filterActions";
        ...
        <div className="column is-narrow">
          ...
          <label className="checkbox ">
            <input
              ...
              type="checkbox"
            />
            <span className="tag  is-warning is-Danger">Not Confirmed</span>
          </label>
        </div>
        <div className="column is-narrow">
          <DateRangePicker
